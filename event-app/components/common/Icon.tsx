...
const iconImages: IconImages = {
    ...
    slideItem0: require('./../../assets/images/chart/2.png'),
    slideItem1: require('./../../assets/images/chart/4.png'),
    slideItem2: require('./../../assets/images/chart/3.png'),
    slideItem3: require('./../../assets/images/chart/1.png'),
    logo4k: require('./../../assets/images/logo4k.png'),
    darkIndex: require('../../assets/images/tabBar/dark/Vector444(Stroke).png'),
    lightIndex: require('../../assets/images/tabBar/light/home.png'),
    darkUser: require('./../../assets/images/tabBar/dark/User.png'),
    lightUser: require('./../../assets/images/tabBar/light/User.png'),
    darkHelp: require('./../../assets/images/tabBar/dark/Learn.png'),
    lightHelp: require('./../../assets/images/tabBar/light/Learn.png'),
    darkProducts: require('./../../assets/images/tabBar/dark/apple.png'),
    lightProducts: require('./../../assets/images/tabBar/light/Vector.png'),
    darkShop: require('./../../assets/images/tabBar/dark/Shop.png'),
    lightShop: require('./../../assets/images/tabBar/light/Shop.png'),
};
