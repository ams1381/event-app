...
const AddReqPopup: React.FC<AddFarmer> = ({active, setActive, refreshFarmerData, routeId}) => {

  const [title, setTitle] = useState<string>()
  const [description, setDescription] = useState<string>()
  const [worker_count_needed, setWorker_count_needed] = useState<string>()
  ...
  const ceateRechandler = () => {
    setLoading(true)
    axiosInstance.post('api/expert/worker_requests/', {
      statuts: 'p',
      title: title?.trim(),
      worker_count_needed: worker_count_needed?.trim(),
      ...
      <View style={styles.bottomSheet}>
        <ScrollView>
          <View style={styles.head}>
            ...
            <Text style={styles.headText}> افزودن درخواست</Text>
          </View>
          <View style={{marginBottom: 10}}>
            ...
            <View style={{
              ...
              <TextInput keyboardType={'phone-pad'} value={worker_count_needed} onChangeText={(e) => setWorker_count_needed(e)} placeholder={'تعداد کارگر'}
                         style={{textAlign: 'right', fontSize: 14, padding: 12, fontFamily: 'bold'}}
                         placeholderTextColor={'#7E7E7E'}/>
            </View>
            <View style={{
              ...
              <TextInput value={description} onChangeText={(e) => setDescription(e)} placeholder={'توضیحات'}
                         style={{textAlign: 'right', fontSize: 14, padding: 12, fontFamily: 'bold'}}
                         placeholderTextColor={'#7E7E7E'}/>
            </View>
