        ...
        <ScrollView style={{
            ...
            <View style={styles.container}>
                ...
                <View style={styles.btnContainer}>
                    <TouchableNativeFeedback onPress={() => router.push('/user-panel/')} style={{borderRadius: 10}}>
            ...
            <InfoBottomSheet toUp={-200} isActivePopup={isActivePopup} setIsActivePopup={setIsActivePopup} bottomSheetOpen={isActivePopup}/>
        </ScrollView>
    )
}
